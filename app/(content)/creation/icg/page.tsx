...
const mediaJSON = [
  {
    ...
    thumb:
      'https://plus.unsplash.com/premium_photo-1741194732590-95a096a10942?q=80&w=1588&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
...
export default function CGIPage() {
  return (
    <div className="space-y-6">
      <VideoGallery mediaJSON={mediaJSON} />
    </div>
  );
}
